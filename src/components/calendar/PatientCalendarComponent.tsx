    ...
    for (let i = 0; i < 7; i++) {
      ...
      days.push(
        <div
          ...
          className={`min-h-[120px] p-2 border-r border-b border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${
            !isSameMonth(cellDate, monthStart) ? 'bg-gray-50 dark:bg-gray-950 text-gray-400 dark:text-gray-500' : 'bg-white dark:bg-gray-900'
          }`}
