-- Add duration and end_time columns to consultations table (with proper constraint handling)
-- This migration handles existing constraints properly
...
ALTER TABLE public.consultations DROP CONSTRAINT IF EXISTS check_duration_positive;
ALTER TABLE public.consultations 
ADD CONSTRAINT check_duration_positive 
CHECK (duration_minutes > 0 AND duration_minutes <= 480); -- Max 8 hours

ALTER TABLE public.consultations DROP CONSTRAINT IF EXISTS check_end_time_after_start;
ALTER TABLE public.consultations 
